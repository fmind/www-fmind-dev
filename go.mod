...
// Code generators and small utilities via the native tool directive. Heavy CLIs
// (golangci-lint, gotestsum, gitleaks, tailwind) are managed by mise instead, to
// keep this module's dependency graph lean.
tool (
