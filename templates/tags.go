...
var TAGS = []Tag{
	{Name: "Agent", Description: "AI agents, agent platforms, and agent protocols."},
	// Coding splits the agent bucket, which otherwise covered half the archive and
	// made its filter chip useless: agents that write software are a distinct
	// audience from the platform and protocol work under Agent.
	{Name: "Coding", Description: "Coding agents, agentic development workflows, and developer tooling."},
